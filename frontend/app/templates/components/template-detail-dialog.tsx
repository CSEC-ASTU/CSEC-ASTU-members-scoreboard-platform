...
export function TemplateDetailDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl bg-white dark:bg-[#0f0f13] border-zinc-200 dark:border-white/10 p-0 overflow-hidden shadow-2xl rounded-2xl">
        {/* ── Large Certificate Preview at the Top (Notion Document Style) ── */}
        <div className="p-5 sm:p-7 bg-zinc-100 dark:bg-zinc-950/80 border-b border-zinc-200 dark:border-white/[0.08] flex items-center justify-center">
          <div className="w-full max-w-lg shadow-md rounded-md overflow-hidden">
        ...
        <div className="p-6 sm:p-7 space-y-6 max-h-[60vh] overflow-y-auto">
          ...
          <div className="rounded-xl border border-zinc-200/80 dark:border-white/[0.08] bg-zinc-50/60 dark:bg-white/[0.02] divide-y divide-zinc-200/60 dark:divide-white/[0.05] text-xs">
            <div className="grid grid-cols-3 py-2.5 px-3.5">
          ...
          <div className="p-3.5 rounded-xl border border-zinc-200 dark:border-white/[0.08] bg-zinc-50 dark:bg-white/[0.02] flex items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 pt-2">
            <Button
              ...
              className="h-9 text-xs border-zinc-300 dark:border-zinc-700 text-zinc-600 dark:text-zinc-300"
            >
              Close
            </Button>
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="h-9 text-xs bg-zinc-900 hover:bg-zinc-800 text-white dark:bg-white dark:hover:bg-zinc-100 dark:text-zinc-950 font-medium gap-1.5 shadow-sm"
              >
