export default function OfflinePage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-3 bg-zinc-50 dark:bg-[#09090B] px-6 text-center text-zinc-900 dark:text-zinc-100">
